...
/// <summary>
///     GetDocumentMetaDataPaymentDetails
/// </summary>
[DataContract]
public sealed class GetDocumentMetaDataPaymentDetails : IEquatable<GetDocumentMetaDataPaymentDetails>
{
	/// <summary>
	///     Initializes a new instance of the <see cref="GetDocumentMetaDataPaymentDetails" /> class.
	/// </summary>
	...
	public GetDocumentMetaDataPaymentDetails(string senderEmail = default, string recipientEmail = default,
	...
	/// <summary>
	///     Returns true if GetDocumentMetaDataPaymentDetails instances are equal
	/// </summary>
	/// <param name="input">Instance of GetDocumentMetaDataPaymentDetails to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(GetDocumentMetaDataPaymentDetails input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class GetDocumentMetaDataPaymentDetails {\n");
	...
	{
		return Equals(input as GetDocumentMetaDataPaymentDetails);
	}
