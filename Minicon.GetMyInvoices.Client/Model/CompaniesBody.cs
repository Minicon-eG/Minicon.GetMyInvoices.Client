...
/// </summary>
[DataContract]
public sealed class CompaniesBody : IEquatable<CompaniesBody>
{
	/// <summary>
	///     Initializes a new instance of the <see cref="CompaniesBody" /> class.
	/// </summary>
	/// <param name="name">Name of the company. (required).</param>
	/// <param name="countryUid">PRIM_UID of the country. (required).</param>
	...
	public CompaniesBody(string name = default, int? countryUid = default, List<string> tags = default,
		...
		string commercialRegister = default, string iban = default, string bic = default, string url = default)
	{
		...
		if (name == null)
		{
			throw new InvalidDataException("name is a required property for CompaniesBody and cannot be null");
		}

		Name = name;
		// to ensure "countryUid" is required (not null)
		if (countryUid == null)
		{
			throw new InvalidDataException("countryUid is a required property for CompaniesBody and cannot be null");
		}
	...
	/// <summary>
	///     Returns true if CompaniesBody instances are equal
	/// </summary>
	/// <param name="input">Instance of CompaniesBody to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(CompaniesBody input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as CompaniesBody);
	}
