...
/// </summary>
[DataContract]
public sealed class CreateTransaction : IEquatable<CreateTransaction>
{
	/// <summary>
	...
	public CreateTransaction(bool? success = default, CreateTransactionMetaData metaData = default)
	{
		Success = success;
		MetaData = metaData;
	}
	...
	public CreateTransactionMetaData MetaData { get; set; }

	/// <summary>
	///     Returns true if CreateTransaction instances are equal
	/// </summary>
	/// <param name="input">Instance of CreateTransaction to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(CreateTransaction input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as CreateTransaction);
	}
