...
/// </summary>
[DataContract]
public sealed class ListBankAccounts : IEquatable<ListBankAccounts>
{
	/// <summary>
	///     Initializes a new instance of the <see cref="ListBankAccounts" /> class.
	/// </summary>
	/// <param name="totalCount">Total Count.</param>
	/// <param name="maxAmount">Max Amount.</param>
	/// <param name="offset">Offset.</param>
	/// <param name="records">records.</param>
	public ListBankAccounts(int? totalCount = default, int? maxAmount = default, int? offset = default,
		List<ListBankAccountsRecords> records = default)
	{
	...
	public List<ListBankAccountsRecords> Records { get; set; }

	/// <summary>
	///     Returns true if ListBankAccounts instances are equal
	/// </summary>
	/// <param name="input">Instance of ListBankAccounts to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ListBankAccounts input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class ListBankAccounts {\n");
	...
	{
		return Equals(input as ListBankAccounts);
	}
