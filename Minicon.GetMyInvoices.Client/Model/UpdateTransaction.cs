...
/// </summary>
[DataContract]
public sealed class UpdateTransaction : IEquatable<UpdateTransaction>
{
	/// <summary>
	...
	public UpdateTransaction(bool? success = default, CreateTransactionMetaData metaData = default)
	{
		Success = success;
		MetaData = metaData;
	}
	...
	{
		return Equals(input as UpdateTransaction);
	}
