...
/// <summary>
///     GetDocumentMetaDataTransactionsRecords
/// </summary>
[DataContract]
public sealed class GetDocumentMetaDataTransactionsRecords : IEquatable<GetDocumentMetaDataTransactionsRecords>
{
	/// <summary>
	///     Initializes a new instance of the <see cref="GetDocumentMetaDataTransactionsRecords" /> class.
	/// </summary>
	...
	public GetDocumentMetaDataTransactionsRecords(int? transactionUid = default, int? accountUid = default,
	...
	/// <summary>
	///     Returns true if GetDocumentMetaDataTransactionsRecords instances are equal
	/// </summary>
	/// <param name="input">Instance of GetDocumentMetaDataTransactionsRecords to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(GetDocumentMetaDataTransactionsRecords input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class GetDocumentMetaDataTransactionsRecords {\n");
	...
	{
		return Equals(input as GetDocumentMetaDataTransactionsRecords);
	}
