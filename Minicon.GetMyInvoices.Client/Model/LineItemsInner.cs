...
/// </summary>
[DataContract]
public sealed class LineItemsInner : IEquatable<LineItemsInner>
{
	/// <summary>
	///     Initializes a new instance of the <see cref="LineItemsInner" /> class.
	/// </summary>
	...
	public LineItemsInner(decimal? quantity = default, string description = default, decimal? taxPercentage = default,
		decimal? taxAmount = default, decimal? unitNetPrice = default, decimal? totalGross = default)
	{
		Quantity = quantity;
	...
	/// <summary>
	///     Returns true if LineItemsInner instances are equal
	/// </summary>
	/// <param name="input">Instance of LineItemsInner to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(LineItemsInner input)
	{
		if (input == null)
		{
			return false;
	...
	public override string ToString()
	{
		...
		sb.Append("class LineItemsInner {\n");
	...
	{
		return Equals(input as LineItemsInner);
	}
