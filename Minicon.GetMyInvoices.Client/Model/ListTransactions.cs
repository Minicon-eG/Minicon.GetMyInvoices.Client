...
/// </summary>
[DataContract]
public sealed class ListTransactions : IEquatable<ListTransactions>
{
	/// <summary>
	...
	public ListTransactions(int? totalCount = default, int? maxAmount = default, int? offset = default,
		List<ListTransactionsRecords> records = default)
	{
	...
	public List<ListTransactionsRecords> Records { get; set; }

	/// <summary>
	///     Returns true if ListTransactions instances are equal
	/// </summary>
	/// <param name="input">Instance of ListTransactions to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(ListTransactions input)
	{
		if (input == null)
		{
			return false;
	...
	{
		return Equals(input as ListTransactions);
	}
