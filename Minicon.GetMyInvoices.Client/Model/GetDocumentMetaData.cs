...
/// </summary>
[DataContract]
public sealed class GetDocumentMetaData : IEquatable<GetDocumentMetaData>
{
	/// <summary>
	///     Initializes a new instance of the <see cref="GetDocumentMetaData" /> class.
	/// </summary>
	...
	/// <param name="workflowDetails">workflowDetails.</param>
	public GetDocumentMetaData(int? documentUid = default, DateTime createdAt = default, int? companyUid = default,
		...
		decimal? vat = default, List<string> taxRates = default, decimal? grossAmount = default,
		string currency = default, bool? isArchived = default, bool? isLocked = default, int? isOcrCompleted = default,
		List<string> tags = default, string note = default, string source = default, string sourceUser = default,
		string filename = default, string fileSize = default, string paymentStatus = default,
		int? supplierUid = default, string paymentMethod = default, int? attachments = default,
		GetDocumentMetaDataPaymentDetails paymentDetails = default,
		List<GetDocumentMetaDataLineItems> lineItems = default, GetDocumentMetaDataTransactions transactions = default,
		GetDocumentMetaDataWorkflowDetails workflowDetails = default)
	{
	...
	public GetDocumentMetaDataPaymentDetails PaymentDetails { get; set; }

	/// <summary>
	///     Gets or Sets LineItems
	/// </summary>
	[DataMember(Name = "lineItems", EmitDefaultValue = false)]
	public List<GetDocumentMetaDataLineItems> LineItems { get; set; }

	/// <summary>
	///     Gets or Sets Transactions
	/// </summary>
	[DataMember(Name = "transactions", EmitDefaultValue = false)]
	public GetDocumentMetaDataTransactions Transactions { get; set; }

	/// <summary>
	///     Gets or Sets WorkflowDetails
	/// </summary>
	[DataMember(Name = "workflowDetails", EmitDefaultValue = false)]
	public GetDocumentMetaDataWorkflowDetails WorkflowDetails { get; set; }

	/// <summary>
	///     Returns true if GetDocumentMetaData instances are equal
	/// </summary>
	/// <param name="input">Instance of GetDocumentMetaData to be compared</param>
	/// <returns>Boolean</returns>
	public bool Equals(GetDocumentMetaData input)
	{
		if (input == null)
		{
			return false;
		...
		return
			...
			(
				...
				(SourceUser != null &&
				 SourceUser.Equals(input.SourceUser))
			) &&
			(
			...
			(
				...
				(Attachments != null &&
				 Attachments.Equals(input.Attachments))
			) &&
			(
			...
			(
				...
				(Transactions != null &&
				 Transactions.Equals(input.Transactions))
			) &&
			(
				WorkflowDetails == input.WorkflowDetails ||
				(WorkflowDetails != null &&
				 WorkflowDetails.Equals(input.WorkflowDetails))
			);
	}
	...
	{
		return Equals(input as GetDocumentMetaData);
	}
	...
	public override int GetHashCode()
	{
		unchecked // Overflow is fine, just wrap
		{
			...
			if (SourceUser != null)
			{
				hashCode = hashCode * 59 + SourceUser.GetHashCode();
			}
			...
			{
				hashCode = hashCode * 59 + WorkflowDetails.GetHashCode();
			}
